        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="streamline b-l m-b m-l">
                    <div class="sl-item">
                    <div class="sl-left">
                        <img src="<?php echo base_url(); ?>flatkit/assets/images/a2.jpg" class="img-circle">
                    </div>
                    <div class="sl-content">
                    ...
                    <div class="sl-item">
                    <div class="sl-left">
                        <img src="<?php echo base_url(); ?>flatkit/assets/images/a5.jpg" class="img-circle">
                    </div>
                    <div class="sl-content">
                    ...
                    <div class="sl-item">
                    <div class="sl-left">
                        <img src="<?php echo base_url(); ?>flatkit/assets/images/a8.jpg" class="img-circle">
                    </div>
                    <div class="sl-content">
    ...
    <div class="col-md-12 col-xl-4">
        <div class="box">
            ...
            <ul class="list no-border">
                <li class="list-item">
                    <a href="" class="pull-left w-40 m-r"><img src="<?php echo base_url(); ?>flatkit/assets/images/a1.jpg" class="img-responsive img-circle"></a>
                    <div class="clear">
                ...
                <li class="list-item">
                    <a href="" class="pull-left w-40 m-r"><img src="<?php echo base_url(); ?>flatkit/assets/images/a2.jpg" class="img-responsive img-circle"></a>
                    <div class="clear">
                ...
                <li class="list-item">
                    <a href="" class="pull-left w-40 m-r"><img src="<?php echo base_url(); ?>flatkit/assets/images/a3.jpg" class="img-responsive img-circle"></a>
                    <div class="clear">
                ...
                <li class="list-item">
                    <a href="" class="pull-left w-40 m-r"><img src="<?php echo base_url(); ?>flatkit/assets/images/a4.jpg" class="img-responsive img-circle"></a>
                    <div class="clear">
        ...
        <div class="box">
            ...
            <ul class="list no-border">
                ...
                <a herf class="pull-left m-r">
                    <span class="w-40">
                        <img src="<?php echo base_url(); ?>flatkit/assets/images/b1.jpg" class="w-full" alt="...">
                    </span>
                </a>
                <div class="clear">
                ...
                <a herf class="pull-left m-r">
                    <span class="w-40">
                        <img src="<?php echo base_url(); ?>flatkit/assets/images/b2.jpg" class="w-full" alt="...">
                    </span>
                </a>
                <div class="clear">
                ...
                <a herf class="pull-left m-r">
                    <span class="w-40">
                        <img src="<?php echo base_url(); ?>flatkit/assets/images/b3.jpg" class="w-full" alt="...">
                    </span>
                </a>
                <div class="clear">
                ...
                <a herf class="pull-left m-r">
                    <span class="w-40">
                        <img src="<?php echo base_url(); ?>flatkit/assets/images/b4.jpg" class="w-full" alt="...">
                    </span>
                </a>
                <div class="clear">
                ...
                <a herf class="pull-left m-r">
                    <span class="w-40">
                        <img src="<?php echo base_url(); ?>flatkit/assets/images/b5.jpg" class="w-full" alt="...">
                    </span>
                </a>
                <div class="clear">
